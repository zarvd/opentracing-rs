...
impl Response {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<Response> {
    i_prot.read_struct_begin()?;
...
// pub const C_L_I_E_N_T_S_E_N_D: String = "cs".to_owned();

// pub const C_L_I_E_N_T_R_E_C_V: String = "cr".to_owned();

// pub const S_E_R_V_E_R_S_E_N_D: String = "ss".to_owned();

// pub const S_E_R_V_E_R_R_E_C_V: String = "sr".to_owned();

// pub const M_E_S_S_A_G_E_S_E_N_D: String = "ms".to_owned();

// pub const M_E_S_S_A_G_E_R_E_C_V: String = "mr".to_owned();

// pub const W_I_R_E_S_E_N_D: String = "ws".to_owned();

// pub const W_I_R_E_R_E_C_V: String = "wr".to_owned();

// pub const C_L_I_E_N_T_S_E_N_D_F_R_A_G_M_E_N_T: String = "csf".to_owned();

// pub const C_L_I_E_N_T_R_E_C_V_F_R_A_G_M_E_N_T: String = "crf".to_owned();

// pub const S_E_R_V_E_R_S_E_N_D_F_R_A_G_M_E_N_T: String = "ssf".to_owned();

// pub const S_E_R_V_E_R_R_E_C_V_F_R_A_G_M_E_N_T: String = "srf".to_owned();

// pub const L_O_C_A_L_C_O_M_P_O_N_E_N_T: String = "lc".to_owned();

// pub const C_L_I_E_N_T_A_D_D_R: String = "ca".to_owned();

// pub const S_E_R_V_E_R_A_D_D_R: String = "sa".to_owned();

// pub const M_E_S_S_A_G_E_A_D_D_R: String = "ma".to_owned();
...
impl <C: TThriftClient + TZipkinCollectorSyncClientMarker> TZipkinCollectorSyncClient for C {
  fn submit_zipkin_batch(&mut self, spans: Vec<Span>) -> thrift::Result<Vec<Response>> {
    (
      {
        ...
        let call_args = SubmitZipkinBatchArgs { spans: spans };
    ...
    )?;
    {
      ...
      let result = SubmitZipkinBatchResult::read_from_in_protocol(self.i_prot_mut())?;
      self.i_prot_mut().read_message_end()?;
      result.ok_or()
    }
  }
...
impl <H: ZipkinCollectorSyncHandler> ZipkinCollectorSyncProcessor<H> {
  ...
  fn process_submit_zipkin_batch(&self, incoming_sequence_number: i32, i_prot: &mut TInputProtocol, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
...
impl TZipkinCollectorProcessFunctions {
  pub fn process_submit_zipkin_batch<H: ZipkinCollectorSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut TInputProtocol, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
    let args = SubmitZipkinBatchArgs::read_from_in_protocol(i_prot)?;
    match handler.handle_submit_zipkin_batch(args.spans) {
      Ok(handler_return) => {
        ...
        let ret = SubmitZipkinBatchResult { result_value: Some(handler_return) };
...
//
// SubmitZipkinBatchArgs
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SubmitZipkinBatchArgs {
  spans: Vec<Span>,
}

impl SubmitZipkinBatchArgs {
  fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SubmitZipkinBatchArgs> {
    i_prot.read_struct_begin()?;
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("SubmitZipkinBatchArgs.spans", &f_1)?;
    let ret = SubmitZipkinBatchArgs {
...
//
// SubmitZipkinBatchResult
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SubmitZipkinBatchResult {
  result_value: Option<Vec<Response>>,
}

impl SubmitZipkinBatchResult {
  fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SubmitZipkinBatchResult> {
    i_prot.read_struct_begin()?;
    ...
    i_prot.read_struct_end()?;
    let ret = SubmitZipkinBatchResult {
      result_value: f_0,
    };
    Ok(ret)
  }
  fn write_to_out_protocol(&self, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("SubmitZipkinBatchResult");
    o_prot.write_struct_begin(&struct_ident)?;
      ...
      Err(
        thrift::Error::Application(
          ApplicationError::new(
            ...
            "no result received for SubmitZipkinBatch"
          )
        )
      )
    }
