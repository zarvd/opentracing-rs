...
impl TagType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<TagType> {
...
impl SpanRefType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SpanRefType> {
    let enum_value = i_prot.read_i32()?;
...
impl TryFrom<i32> for SpanRefType {
  type Err = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Err> {
    match i {
      0 => Ok(SpanRefType::CHILD_OF),
      1 => Ok(SpanRefType::FOLLOWS_FROM),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
...
impl Tag {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<Tag> {
...
impl Log {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<Log> {
    i_prot.read_struct_begin()?;
...
impl SpanRef {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SpanRef> {
    i_prot.read_struct_begin()?;
...
impl Span {
  pub fn new<F6, F10, F11, F12>(trace_id_low: i64, trace_id_high: i64, span_id: i64, parent_span_id: i64, operation_name: String, references: F6, flags: i32, start_time: i64, duration: i64, tags: F10, logs: F11, incomplete: F12) -> Span where F6: Into<Option<Vec<SpanRef>>>, F10: Into<Option<Vec<Tag>>>, F11: Into<Option<Vec<Log>>>, F12: Into<Option<bool>> {
    Span {
      trace_id_low: trace_id_low,
      trace_id_high: trace_id_high,
      span_id: span_id,
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
    ...
    if let Some(fld_var) = self.incomplete {
      o_prot.write_field_begin(&TFieldIdentifier::new("incomplete", TType::Bool, 12))?;
      o_prot.write_bool(fld_var)?;
      o_prot.write_field_end()?;
      ()
    } else {
...
impl Process {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<Process> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<String> = None;
    let mut f_2: Option<Vec<Tag>> = None;
    loop {
...
impl Batch {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<Batch> {
    i_prot.read_struct_begin()?;
...
impl BatchSubmitResponse {
  ...
  pub fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<BatchSubmitResponse> {
    i_prot.read_struct_begin()?;
...
impl <C: TThriftClient + TCollectorSyncClientMarker> TCollectorSyncClient for C {
  fn submit_batches(&mut self, batches: Vec<Batch>) -> thrift::Result<Vec<BatchSubmitResponse>> {
    (
      {
        ...
        let call_args = SubmitBatchesArgs { batches: batches };
    ...
    )?;
    {
      ...
      let result = SubmitBatchesResult::read_from_in_protocol(self.i_prot_mut())?;
      self.i_prot_mut().read_message_end()?;
      result.ok_or()
    }
  }
...
impl <H: CollectorSyncHandler> CollectorSyncProcessor<H> {
  ...
  fn process_submit_batches(&self, incoming_sequence_number: i32, i_prot: &mut TInputProtocol, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
...
impl TCollectorProcessFunctions {
  pub fn process_submit_batches<H: CollectorSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut TInputProtocol, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
    let args = SubmitBatchesArgs::read_from_in_protocol(i_prot)?;
    match handler.handle_submit_batches(args.batches) {
      Ok(handler_return) => {
        ...
        let ret = SubmitBatchesResult { result_value: Some(handler_return) };
...
#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SubmitBatchesArgs {
  batches: Vec<Batch>,
}

impl SubmitBatchesArgs {
  fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SubmitBatchesArgs> {
    i_prot.read_struct_begin()?;
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("SubmitBatchesArgs.batches", &f_1)?;
    let ret = SubmitBatchesArgs {
...
#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SubmitBatchesResult {
  result_value: Option<Vec<BatchSubmitResponse>>,
}

impl SubmitBatchesResult {
  fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SubmitBatchesResult> {
    i_prot.read_struct_begin()?;
    ...
    i_prot.read_struct_end()?;
    let ret = SubmitBatchesResult {
      result_value: f_0,
    };
    Ok(ret)
  }
  fn write_to_out_protocol(&self, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("SubmitBatchesResult");
    o_prot.write_struct_begin(&struct_ident)?;
      ...
      Err(
        thrift::Error::Application(
          ApplicationError::new(
            ...
            "no result received for SubmitBatches"
          )
        )
      )
    }
